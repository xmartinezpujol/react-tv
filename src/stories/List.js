...
storiesOf('Carousel', module)
  .addDecorator(backgrounds([
    ...
    { name: 'grey', value: '#EAEAEA' },
  ]))
  .addDecorator(withKnobs)
  .addDecorator(withTests('CarouselHero', 'Carousel'))
  .add(
    'hero',
    withInfo(`
        <p>This a Carousel component that uses Hero images as Items.</p>
        
        ##### Required Props

        <p>
          <li><strong>height</strong> : height of the Hero images</li>
          <li><strong>slides</strong> : data for the slides</li>
        </p>
      `)(() => (
      <CarouselHero
  ...
  .add(
    'EventList',
    withInfo(`
        Carousel that doesn't have physics.
          
        ##### Required Props
        
        
          - **dimensions** : width and height for the different card sizes (responsive)
          - **imgHeights** : image height for the different card sizes (responsive)
          - **fullWidthMode** : enable when Carousel takes full window width
      `)(() => {
...
const EventTitle = glamorous.div({
  position: 'absolute',
  bottom: 20,
  left: 80,
  zIndex: 70,
